          ...
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="space-y-4">
              <p className="text-sm leading-7 nw-muted">
                You are now on the trial plan with room for three hosts and twenty-four hours of retention.
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="nw-stat-card">
                  <div className="text-xs uppercase tracking-[0.18em] nw-subtle">Trial</div>
                  <div className="mt-2 text-xl font-semibold">14 days</div>
                  <div className="mt-1 text-sm nw-muted">no card required</div>
                </div>
                <div className="nw-stat-card">
                  <div className="text-xs uppercase tracking-[0.18em] nw-subtle">Capacity</div>
                  <div className="mt-2 text-xl font-semibold">3 hosts</div>
  ...
  return (
    <div className="grid gap-8 py-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:py-20">
      <section className="space-y-6">
        <span className="nw-kicker">Early access</span>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="nw-stat-card">
            <div className="text-xs uppercase tracking-[0.18em] nw-subtle">Trial</div>
            <div className="mt-2 text-2xl font-semibold">14 days</div>
            <div className="mt-1 text-sm nw-muted">no card required</div>
          </div>
          <div className="nw-stat-card">
            <div className="text-xs uppercase tracking-[0.18em] nw-subtle">Retention</div>
            <div className="mt-2 text-2xl font-semibold">24h</div>
            <div className="mt-1 text-sm nw-muted">out of the box</div>
          </div>
          <div className="nw-stat-card">
            <div className="text-xs uppercase tracking-[0.18em] nw-subtle">Scale</div>
            <div className="mt-2 text-2xl font-semibold">3 hosts</div>
            <div className="mt-1 text-sm nw-muted">before you pay</div>
          </div>
        </div>
      </section>
